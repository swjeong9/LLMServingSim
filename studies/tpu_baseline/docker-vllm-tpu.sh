#!/bin/bash
# Launch vLLM-TPU Docker for studies/tpu_baseline/ sweeps.
#
...
#     bash studies/tpu_baseline/docker-vllm-tpu.sh
#
...
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"   # .../studies/tpu_baseline
