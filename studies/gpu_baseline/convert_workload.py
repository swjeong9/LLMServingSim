...
GPU baseline equivalent of studies/inf2_baseline/convert_workload.py.
Default paths point at studies/gpu_baseline/, but data/datasets is a
symlink back to inf2_baseline so the source CSVs stay shared.
...
-----
    ...
    python studies/gpu_baseline/convert_workload.py \\
...
def main():
    ...
    p.add_argument("--data-dir",
                   default="studies/gpu_baseline/data/datasets",
                   help="dataset CSV directory")
    p.add_argument("--output-dir",
                   default="studies/gpu_baseline/workloads",
