...
#
# Output: studies/tpu_v6e_baseline/results/lens_vllm/<model>/tp<N>/bs<B>/<dataset>_<ts>.csv
...
run_vllm() {
    ...
    local dir="studies/tpu_v6e_baseline/results/lens_vllm/${MODEL_LABEL}/tp${tp}/bs${bs}"
...
echo "  results: studies/tpu_v6e_baseline/results/lens_vllm/${MODEL_LABEL}/"
