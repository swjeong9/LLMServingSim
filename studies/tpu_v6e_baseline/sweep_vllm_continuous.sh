...
#
# Output: studies/tpu_v6e_baseline/results/lens_vllm_continuous/<model>/tp<N>/bs<B>/<dataset>_<ts>.csv
#         + <dataset>.csv stable symlink to the latest run.
#
# Edit the variables at the top, then run from repo root:
#     bash studies/tpu_v6e_baseline/sweep_vllm_continuous.sh
...
run_vllm() {
    ...
    local dir="studies/tpu_v6e_baseline/results/lens_vllm_continuous/${MODEL_LABEL}/tp${tp}/bs${bs}"
...
echo "  results: studies/tpu_v6e_baseline/results/lens_vllm_continuous/${MODEL_LABEL}/"
