...
Usage (called by profile_tpu.sh; can also be run standalone):
    ...
    cd profiler/perf_models/TPU-v6e-1
    python profile_jax.py --stage dense --layer qkv_proj \\
        --model meta-llama/Llama-3.2-1B-Instruct --tp 1 \\
        --token-list "1,2,4,8,16,32,64,128" \\
        --output-dir ../../../profiler/perf/TPU-v6e-1/meta-llama/Llama-3.2-1B-Instruct/bf16/tp1
"""
import argparse
import csv
import os
...
def main():
    ...
    p.add_argument('--hw', default='TPU-v6e-1')
